...
const setAppSummarySorting = (summarySorting: Types.Sorting) => ({ type: 'SET_APP_SUMMARY_SORTING', summarySorting } as const)
const setAppDetailsSorting = (detailsSorting: Types.Sorting) => ({ type: 'SET_APP_DETAILS_SORTING', detailsSorting } as const)
